...
export function NavMenuHeader() {
  ...
  return (
    <nav className="w-full fixed top-0 left-0">
      <div className="bg-bgDarkColor md:bg-transparent md:flex items-center justify-between py-4 md:py-6 h-24 md:px-20 px-7">
        <Image
        ...
        <ul
          className={`md:flex md:items-center text-center md:gap-6 md:pb-0 pb-12 absolute md:static md:bg-transparent bg-bgDarkColor md:z-auto z-[-1] w-full left-0 md:w-auto md:pl-0 pl-9 transition-all duration-500 easy-in ${
            open ? 'top-16' : '-top-96'
          }`}
        >
